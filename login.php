...
if(isset($_POST["username"])){
	...
	$temp=$pdo->query("select * from member where username ='$username' and password ='$password'");
	if($temp->fetch()){
...
<div align="center">
    <div class="container">
        ...
        <div class="ct"><!--This is Container -->
			...
			if(isset($_GET["err"])){
			?>
            <font color="#FF0000">Username Or Password Incorrect</font>
            <?php } ?>
            <br>
            ...
            <h3>ข้อตกลงในการใช้งานเว็บ CodeSpace</h3>
            <br>
